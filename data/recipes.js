export const recipes = [
    ...
    },
    {
        ...
        "time": 50,
        "description": "Faire cuire le riz. Une fois le riz cuit, le laisser refroidir. Couper les oeufs dur en quarts ou en lamelle au choix, couper les tomates en dés, ajouter au riz les oeufs, les tomates, le poisson, le maïs et la vinaigrette. Ajouter au goût de chacun des cornichons, olives etc..",
    ...
    },
    {
        ...
        "time": 45,
        "description": "Etaler la pâte feuilletée aux dimensions du moule, étaler la moutarde sur la pâte feuilletée, ajouter le thon. Découper les tomates en rondelles et les poser sur le poisson, ajouter un peu de crème fraîche sur toute la tarte et recouvrir de gruyère râpé. Cuire au four 30 minutes.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 60,
        "description": "Hacher les noix grossièrement. Faire fondre le chocolat avec le beurre. Mélanger les oeufs et le sucre et mélanger au chocolat. Ajouter la farine. Mélanger afin d'avoir quelque chose d'homogène puis incorporer les noix. Verser la préparation dans un moule de préférence rectangulaire. Cuire 2O à 25 minutes à 180°C. Sortir du four et attendre quelques minutes pour démouler. Servir avec une boule de glace pour plus de gourmandise.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 15,
        "description": "Peler le concombre et le couper en 2, retirer les pépins. Couper les olives en morceaux, ainsi que le fromage de chèvre. Ajouter le basilic ainsi que le vinaigre balsamique et l'huile d'olive à votre goût.",
        "appliance": "Saladier",
    ...
    },
    {
        ...
        "time": 60,
        "description": "Commencer par cuire les pommes de terre dans l'eau bouillante. Puis les éplucher et les couper en rondelles. Emincer les oignons puis les faire dorer dans du beurre. Ajouter le jambon fumé coupé en morceaux ainsi que les pommes de terre. Saler, poivrer à votre goût (et celui de vos convives). Laisser cuire durant environ 10 minutes puis ajouter le vin blanc. Après 5 minutes, mettre le tout dans un plat à gratin. Couper le reblochon, soit en tranches, soit le couper en 2 dans le sens de l'épaisseur et recouvrir les pommes de terre. Cuire au four (environ 220°C) durant 25 minutes. C'est prêt !",
        "appliance": "Four",
        "utensils": ["Plat à gratin", "Couteau", "Econome"]
    },
    {
        "id": 11,
    ...
    },
    {
        ...
        "time": 40,
        "description": "Cuire les pommes de terre environ 30 minutes. Découper les échalotes finement. Durant la cuisson des pommes de terre, préparer la vinaigrette avec l'huile d'olive et le vinaigre de cidre. Saler et poivrer à discrétion. Dans un saladier, mettre la mâche. Ajouter.",
        "appliance": "Casserole",
    ...
    },
    {
        ...
        "time": 60,
        "description": "Mélanger dans un saladier, la farine, les oeufs, et le lait. Battre jusqu'à avoir une masse homogène. Pendant ce temps, faire fondre le beurre et ajouter en une partie à la pâte à crêpe. Faire fondre le chocolat (avec le reste du beurre salé). Lorsque vous chauffez les crêpes, ajouter le chocolat fondu et les bananes coupées en rondelles. Ajouter une touche de chantilly pour les gourmands.",
    ...
    },
    {
        ...
        "time": 45,
        "description": "Faire cuire les pâtes (si vous n'avez pas de pennes, des coquillettes peuvent faire l'affaire). Découper les tomates en petits morceaux, soit en tranches soit en dés. Couper le basilic en petites morceaux et le mélanger aux tomates. Coupez la mozzarella en tranches. Préchauffer le four à 200°C. Alterner entre couches de pattes et couches de tomates, terminer par une couche de pâtes et recouvrir de fromage. Laisser au four 30 minutes et régalez-vous ! Une recette simple qui fera plaisir aux petits comme aux grands.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 30,
        "description": "Faire fondre le chocolat et le beurre au bain marie. Dans un saladier, battre les oeufs avec le sucre jusqu'à obtenir une texture de type mousse. Ajouter la farine ainsi que le mélange de beurre et chocolat fondu. Beurrer le moule à gâteaux. Mettre au four préchauffé à 200°C puis faire chauffer pendant 15 minutes. C'est prêt. Servir avec une boule de glace ou une crème dessert.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 60,
        "description": "Etaler la pâte dans un moule et la piquer. Parsemer de beurre. Faire chauffer les lardons dans une poêle. Battre les oeufs en ajoutant la crème fraîche et le lait. Finalement ajouter les lardons, saler poivrer à votre goût. Verser l'ensemble sur la pâte. Cuire environ 50 minutes.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 15,
        "description": "Faire fondre l'oseille avec du beurre demi-sel, ajouter un litre d'eau. Ajouter les vermicelles. Laisser cuire. Une fois prêts, sortir du feu et après 5 minutes ajouter le jaune d'oeuf et la crème fraîche.",
        "appliance": "Casserole",
        "utensils": ["Couteau", "Cuillère en bois"]
    },
    {
        ...
        "time": 80,
        "description": "Emincer les blancs de poireaux et les faire chauffer dans 25 grammes de beurre. Ajouter les pommes de terre coupées en morceaux. Ajouter l'eau et laisser mijoter pour 45 minutes. Chauffer l'oseille avec le beurre restant puis incorporer le tout. Mixer. Ajouter la crème. Bon appétit.",
        "appliance": "Mixer",
    ...
    },
    {
        ...
        "time": 30,
        "description": "Prendre les pois chiches, les mettre dans le mixer avec de l'huile d'olive, ajouter le jus des 2 citrons et du paprika selon le goût.",
        "appliance": "Mixer",
    ...
    },
    {
        ...
        "time": 20,
        "description": "Beurrer les tranches de pain, ajouter entre 2 tranches de pain de mie 1 tranche d'emmental, une de blanc de dinde, et une autre d'emmental. Dans un récipient, mélanger le gruyère rapé avec le lait et la noix de muscade. Mettre sur les croques-monsieur. Placer au four durant 10 minutes.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "appliance": "Mixer",
        "utensils": ["Couteau", "Econome", "Cuillère en bois"]
    },
    {
        "id": 35,
    ...
    },
    {
        ...
        "time": 20,
        "description": "Fouetter les oeufs, le sucre et le lait. Tremper les tranches de pain. Le cuire au four pendant environ 10 minutes à 180°C. Servir.",
        "appliance": "Four",
    ...
    }, 
    {
        ...
        "time": 60,
        "description": "Commencer par préparer la mousse au chocolat au moins 2 heures avant. Quand la mousse est prête et a reposé, mouiller alors les boudoirs dans le jus des poires. Disposer. Alterner mousse au chocolat, boudoirs et poires. Mettre au frais.",
    ...
    },
    {
        ...
        "time": 50,
        "description": "Préchauffer le four à 200°C. Etaler la pâte. La mettre dans un moule. Battre les oeufs avec le sucre. Ajouter le jus de citron et le beurre. Verser le tout sur la pâte. Au four 30 minutes. Bon appétit.",
        "appliance": "Four",
    ...
    },
    {
        ...
        "time": 40,
        "description": "Etaler la pâte a pizza. Ecraser les tomates pelées, les étaler sur la pâte, ajouter les lardons et les champignons. Ajouter le gruyère et passer au four à 220°C durant 20 minutes.",
        "appliance": "Four",
